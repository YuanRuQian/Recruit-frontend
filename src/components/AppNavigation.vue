     ...
     <div v-if="this.$store.state.currentUser===null">
        ...
        <div v-else>
         <v-list-item v-on:click="ToPersonalProfile">
          ...
          <v-list-item-content>
            <v-list-item-title>{{this.$store.state.currentUser}}的个人中心</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        ...
        <v-toolbar app color="teal" dark>
           <v-app-bar-nav-icon  @click="drawer = !drawer"></v-app-bar-nav-icon>
            ...
            <div v-else>
                <v-btn color="teal darken-3" class="hidden-sm-and-down" @click="ToPersonalProfile">{{this.$store.state.currentUser}}的个人中心</v-btn>
